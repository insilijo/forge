...
Welcome to the documentation for the insilijo multiomics ecosystem.
...
- [GrAndMA](tools/grandma.md) — the web platform
- [GIZMO](tools/gizmo.md) — metabolite knowledge graph

## Help

[Open an issue](https://github.com/insilijo/forge/issues/new/choose) to report a bug or request a feature.
